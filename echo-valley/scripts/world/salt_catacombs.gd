...
## SALT CATACOMBS — discoverable themed area.
...
func _build_map() -> void:
	...
	encounter_table = "salt_catacombs"
	...
	add_warp(Vector2i(9, 23), "desert3", Vector2i(20, 10), "down")
	add_warp(Vector2i(10, 23), "desert3", Vector2i(21, 10), "down")
	...
	add_interact(Vector2i(9, 21), { "type": "sign", "text": "SALT CATACOMBS - White halls carved from dried sea-beds." })

	add_trainer(Vector2i(5, 10), "right", {
		"id": "salt_catacombs_t0", "name": "Mystic Noa", "look": 11,
		"party": [{ "id": "torrentag", "level": 16 }, { "id": "snaptide", "level": 17 }],
		"reward": 4,
		"intro": ["Salt Catacombs tests every keeper.", "Show me your bond!"],
	...
	add_trainer(Vector2i(14, 14), "left", {
		"id": "salt_catacombs_t1", "name": "Ranger Tess", "look": 4,
		"party": [{ "id": "riverwyrm", "level": 17 }, { "id": "mistpup", "level": 18 }, { "id": "geysero", "level": 19 }],
		"reward": 5,
		"intro": ["Salt Catacombs tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_trainer(Vector2i(6, 17), "up", {
		"id": "salt_catacombs_t2", "name": "Curator Ivo", "look": 11,
		"party": [{ "id": "cryoleth", "level": 18 }, { "id": "coralet", "level": 19 }],
		"reward": 6,
		"intro": ["Salt Catacombs tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_npc(Vector2i(11, 20), "left", Color(1, 1, 1), {
		"type": "npc",
		"lines": [
			"White halls carved from dried sea-beds.",
