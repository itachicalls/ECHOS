...
## GLACIAL ARCHIVE — discoverable themed area.
...
func _build_map() -> void:
	...
	encounter_table = "glacial_archive"
	...
	add_warp(Vector2i(9, 23), "frostvale1", Vector2i(16, 10), "down")
	add_warp(Vector2i(10, 23), "frostvale1", Vector2i(17, 10), "down")
	...
	add_interact(Vector2i(9, 21), { "type": "sign", "text": "GLACIAL ARCHIVE - Frozen shelves of Chorus memory." })

	add_trainer(Vector2i(5, 10), "right", {
		"id": "glacial_archive_t0", "name": "Scout Mira", "look": 10,
		"party": [{ "id": "blinkit", "level": 53 }, { "id": "nyxarch", "level": 54 }],
		"reward": 7,
		"intro": ["Glacial Archive tests every keeper.", "Show me your bond!"],
	...
	add_trainer(Vector2i(14, 14), "left", {
		"id": "glacial_archive_t1", "name": "Keeper Jon", "look": 13,
		"party": [{ "id": "willowick", "level": 54 }, { "id": "draingest", "level": 55 }, { "id": "umbrix", "level": 56 }],
		"reward": 8,
		"intro": ["Glacial Archive tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_trainer(Vector2i(6, 17), "up", {
		"id": "glacial_archive_t2", "name": "Sage Lira", "look": 7,
		"party": [{ "id": "aeonmind", "level": 55 }, { "id": "orbkit", "level": 56 }],
		"reward": 9,
		"intro": ["Glacial Archive tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_legend_encounter(Vector2i(9, 6), "cryoleth", 55,
		"Frost archives awaken. CRYOLETH thaws from a shelf of ice!")

	add_npc(Vector2i(11, 20), "left", Color(1, 1, 1), {
		"type": "npc",
		"lines": [
			"Frozen shelves of Chorus memory.",
...
func _place_pickups() -> void:
	add_pickup(Vector2i(3, 19), "echo_capsule", 5)
	add_pickup(Vector2i(16, 5), "heart_salve", 4)
	add_pickup(Vector2i(4, 9), "great_capsule", 3)
