...
## WINDMILL RIDGE — discoverable themed area.
...
func _build_map() -> void:
	...
	encounter_table = "windmill_ridge"
	...
	add_warp(Vector2i(9, 23), "town", Vector2i(2, 13), "down")
	add_warp(Vector2i(10, 23), "town", Vector2i(3, 13), "down")
	...
	add_interact(Vector2i(9, 21), { "type": "sign", "text": "WINDMILL RIDGE - Old mills still turn on dry winds." })

	add_trainer(Vector2i(5, 10), "right", {
		"id": "windmill_ridge_t0", "name": "Sage Lira", "look": 6,
		"party": [{ "id": "floradiance", "level": 22 }, { "id": "cactopup", "level": 23 }],
		"reward": 4,
		"intro": ["Windmill Ridge tests every keeper.", "Show me your bond!"],
	...
	add_trainer(Vector2i(14, 14), "left", {
		"id": "windmill_ridge_t1", "name": "Hunter Rex", "look": 4,
		"party": [{ "id": "bramblejaw", "level": 23 }, { "id": "voltwing", "level": 24 }, { "id": "voltcanine", "level": 25 }],
		"reward": 5,
		"intro": ["Windmill Ridge tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_trainer(Vector2i(6, 17), "up", {
		"id": "windmill_ridge_t2", "name": "Acolyte Vee", "look": 8,
		"party": [{ "id": "mycelith", "level": 24 }, { "id": "zaptenna", "level": 25 }],
		"reward": 6,
		"intro": ["Windmill Ridge tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_npc(Vector2i(11, 20), "left", Color(1, 1, 1), {
		"type": "npc",
		"lines": [
			"Old mills still turn on dry winds.",
...
func _place_pickups() -> void:
	...
	add_pickup(Vector2i(9, 12), "resonance_bike", 1)
