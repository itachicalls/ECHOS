...
## CLOCKWORK VAULT — discoverable themed area.
...
func _build_map() -> void:
	...
	encounter_table = "clockwork_vault"
	...
	add_warp(Vector2i(9, 23), "abandoned_lab", Vector2i(9, 1), "down")
	add_warp(Vector2i(10, 23), "abandoned_lab", Vector2i(10, 1), "down")
	...
	add_interact(Vector2i(9, 21), { "type": "sign", "text": "CLOCKWORK VAULT - Gears older than the Chorus keep time." })

	add_trainer(Vector2i(5, 10), "right", {
		"id": "clockwork_vault_t0", "name": "Hunter Rex", "look": 9,
		"party": [{ "id": "stormraptor", "level": 32 }, { "id": "statikit", "level": 33 }],
		"reward": 5,
		"intro": ["Clockwork Vault tests every keeper.", "Show me your bond!"],
	...
	add_trainer(Vector2i(14, 14), "left", {
		"id": "clockwork_vault_t1", "name": "Acolyte Vee", "look": 0,
		"party": [{ "id": "tesloom", "level": 33 }, { "id": "kiteon", "level": 34 }, { "id": "arcwing", "level": 35 }],
		"reward": 6,
		"intro": ["Clockwork Vault tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_trainer(Vector2i(6, 17), "up", {
		"id": "clockwork_vault_t2", "name": "Scholar Otto", "look": 2,
		"party": [{ "id": "voltcanine", "level": 34 }, { "id": "ionling", "level": 35 }],
		"reward": 7,
		"intro": ["Clockwork Vault tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_legend_encounter(Vector2i(9, 6), "tesloom", 38,
		"Gears lock. TESLOOM — living dynamo — steps from the vault!")

	add_npc(Vector2i(11, 20), "left", Color(1, 1, 1), {
		"type": "npc",
		"lines": [
			"Gears older than the Chorus keep time.",
