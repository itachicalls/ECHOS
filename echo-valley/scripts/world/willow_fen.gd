...
## WILLOW FEN — discoverable themed area.
...
func _build_map() -> void:
	...
	add_warp(Vector2i(9, 23), "route1", Vector2i(17, 10), "down")
	add_warp(Vector2i(10, 23), "route1", Vector2i(18, 10), "down")
	...
	add_interact(Vector2i(9, 21), { "type": "sign", "text": "WILLOW FEN - Misty willows hide soft-footed Harmons." })

	add_trainer(Vector2i(5, 10), "right", {
		"id": "willow_fen_t0", "name": "Wanderer Ash", "look": 0,
		"party": [{ "id": "bloomhound", "level": 8 }, { "id": "floradiance", "level": 9 }],
		"reward": 3,
		"intro": ["Willow Fen tests every keeper.", "Show me your bond!"],
	...
	add_trainer(Vector2i(14, 14), "left", {
		"id": "willow_fen_t1", "name": "Scout Mira", "look": 9,
		"party": [{ "id": "sprouthound", "level": 9 }, { "id": "bramblejaw", "level": 10 }, { "id": "marowl", "level": 11 }],
		"reward": 4,
		"intro": ["Willow Fen tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_trainer(Vector2i(6, 17), "up", {
		"id": "willow_fen_t2", "name": "Keeper Jon", "look": 7,
	...
	add_npc(Vector2i(11, 20), "left", Color(1, 1, 1), {
		"type": "npc",
		"lines": [
			"Misty willows hide soft-footed Harmons.",
