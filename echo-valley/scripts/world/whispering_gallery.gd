...
## WHISPERING GALLERY — discoverable themed area.
...
func _build_map() -> void:
	...
	encounter_table = "whispering_gallery"
	...
	add_warp(Vector2i(9, 23), "cave1", Vector2i(16, 10), "down")
	add_warp(Vector2i(10, 23), "cave1", Vector2i(17, 10), "down")
	...
	add_interact(Vector2i(9, 21), { "type": "sign", "text": "WHISPERING GALLERY - Echoes answer before you speak." })

	add_trainer(Vector2i(5, 10), "right", {
		"id": "whispering_gallery_t0", "name": "Scout Mira", "look": 12,
		"party": [{ "id": "bedrockus", "level": 25 }, { "id": "clayling", "level": 26 }],
		"reward": 5,
		"intro": ["Whispering Gallery tests every keeper.", "Show me your bond!"],
	...
	add_trainer(Vector2i(14, 14), "left", {
		"id": "whispering_gallery_t1", "name": "Keeper Jon", "look": 16,
		"party": [{ "id": "geodrake", "level": 26 }, { "id": "ironrust", "level": 27 }, { "id": "cobbleton", "level": 28 }],
		"reward": 6,
		"intro": ["Whispering Gallery tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_trainer(Vector2i(6, 17), "up", {
		"id": "whispering_gallery_t2", "name": "Sage Lira", "look": 9,
		"party": [{ "id": "sarcophage", "level": 27 }, { "id": "gravelo", "level": 28 }],
		"reward": 7,
		"intro": ["Whispering Gallery tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_npc(Vector2i(11, 20), "left", Color(1, 1, 1), {
		"type": "npc",
		"lines": [
			"Echoes answer before you speak.",
