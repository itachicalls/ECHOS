...
## CRYSTAL HEART — discoverable themed area.
...
func _build_map() -> void:
	...
	encounter_table = "crystal_mines2"
	...
	add_warp(Vector2i(9, 23), "crystal_mines1", Vector2i(9, 1), "down")
	add_warp(Vector2i(10, 23), "crystal_mines1", Vector2i(10, 1), "down")
	...
	add_interact(Vector2i(9, 21), { "type": "sign", "text": "CRYSTAL HEART - The seam where the Fracture cracked stone." })

	add_trainer(Vector2i(5, 10), "right", {
		"id": "crystal_mines2_t0", "name": "Ranger Tess", "look": 12,
		"party": [{ "id": "stormraptor", "level": 23 }, { "id": "statikit", "level": 24 }],
		"reward": 5,
		"intro": ["Crystal Heart tests every keeper.", "Show me your bond!"],
	...
	add_trainer(Vector2i(14, 14), "left", {
		"id": "crystal_mines2_t1", "name": "Curator Ivo", "look": 17,
		"party": [{ "id": "tesloom", "level": 24 }, { "id": "kiteon", "level": 25 }, { "id": "arcwing", "level": 26 }],
		"reward": 6,
		"intro": ["Crystal Heart tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_trainer(Vector2i(6, 17), "up", {
		"id": "crystal_mines2_t2", "name": "Wanderer Ash", "look": 9,
		"party": [{ "id": "voltcanine", "level": 25 }, { "id": "ionling", "level": 26 }],
		"reward": 7,
		"intro": ["Crystal Heart tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_legend_encounter(Vector2i(9, 6), "arcanexus", 30,
		"The crystal heart pulses. An arcane Harmon steps through!")

	add_npc(Vector2i(11, 20), "left", Color(1, 1, 1), {
		"type": "npc",
		"lines": [
			"The seam where the Fracture cracked stone.",
			"Beat the keepers here — talk to them again for path rumors.",
		],
	}, Tiles.TRAINER_PATHS[8], 1)
