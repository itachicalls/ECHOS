...
## MOONLIT LAKE — discoverable themed area.
...
func _build_map() -> void:
	...
	add_warp(Vector2i(9, 23), "tide_town", Vector2i(16, 10), "down")
	add_warp(Vector2i(10, 23), "tide_town", Vector2i(17, 10), "down")
	...
	add_interact(Vector2i(9, 21), { "type": "sign", "text": "MOONLIT LAKE - Silver water that never warms." })

	add_trainer(Vector2i(5, 10), "right", {
		"id": "moonlit_lake_t0", "name": "Acolyte Vee", "look": 16,
		"party": [{ "id": "shroudmoth", "level": 24 }, { "id": "pyrewraith", "level": 25 }],
		"reward": 5,
		"intro": ["Moonlit Lake tests every keeper.", "Show me your bond!"],
	...
	add_trainer(Vector2i(14, 14), "left", {
		"id": "moonlit_lake_t1", "name": "Scholar Otto", "look": 16,
		"party": [{ "id": "wraithvine", "level": 25 }, { "id": "hypnaura", "level": 26 }, { "id": "orbitot", "level": 27 }],
		"reward": 6,
		"intro": ["Moonlit Lake tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_trainer(Vector2i(6, 17), "up", {
		"id": "moonlit_lake_t2", "name": "Warden Pia", "look": 3,
		"party": [{ "id": "lanternox", "level": 26 }, { "id": "somnarch", "level": 27 }],
		"reward": 7,
		"intro": ["Moonlit Lake tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_legend_encounter(Vector2i(9, 6), "leviaqua", 30,
		"The lake silver-boils. LEVIAQUA surfaces under the moon!")

	add_npc(Vector2i(11, 20), "left", Color(1, 1, 1), {
		"type": "npc",
		"lines": [
			"Silver water that never warms.",
