...
## BELLTOWER CROWN — discoverable themed area.
...
func _build_map() -> void:
	...
	add_warp(Vector2i(9, 23), "belltower2", Vector2i(9, 1), "down")
	add_warp(Vector2i(10, 23), "belltower2", Vector2i(10, 1), "down")
	...
	add_interact(Vector2i(9, 21), { "type": "sign", "text": "BELLTOWER CROWN - Above the clouds — a storm-legend nests here." })

	add_trainer(Vector2i(5, 10), "right", {
		"id": "belltower3_t0", "name": "Keeper Jon", "look": 2,
		"party": [{ "id": "gloomkin", "level": 23 }, { "id": "nocthorn", "level": 24 }],
		"reward": 5,
		"intro": ["Belltower Crown tests every keeper.", "Show me your bond!"],
	...
	add_trainer(Vector2i(14, 14), "left", {
		"id": "belltower3_t1", "name": "Sage Lira", "look": 10,
		"party": [{ "id": "hexling", "level": 24 }, { "id": "spectron", "level": 25 }, { "id": "mortifume", "level": 26 }],
		"reward": 6,
		"intro": ["Belltower Crown tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_trainer(Vector2i(6, 17), "up", {
		"id": "belltower3_t2", "name": "Hunter Rex", "look": 14,
		"party": [{ "id": "murklet", "level": 25 }, { "id": "blotusk", "level": 26 }],
		"reward": 7,
		"intro": ["Belltower Crown tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_legend_encounter(Vector2i(9, 6), "stormraptor", 28,
		"Thunder crowns the spire. A storm-raptor claims the bells!")

	add_npc(Vector2i(11, 20), "left", Color(1, 1, 1), {
		"type": "npc",
		"lines": [
			"Above the clouds — a storm-legend nests here.",
