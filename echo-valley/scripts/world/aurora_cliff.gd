...
## AURORA CLIFF — discoverable themed area.
...
func _build_map() -> void:
	...
	add_warp(Vector2i(9, 23), "frostvale1", Vector2i(3, 10), "down")
	add_warp(Vector2i(10, 23), "frostvale1", Vector2i(4, 10), "down")
	...
	add_interact(Vector2i(9, 21), { "type": "sign", "text": "AURORA CLIFF - Lights dance where ice meets sky." })

	add_trainer(Vector2i(5, 10), "right", {
		"id": "aurora_cliff_t0", "name": "Seeker Cal", "look": 8,
		"party": [{ "id": "kackaburr", "level": 45 }, { "id": "aquari", "level": 46 }],
		"reward": 7,
		"intro": ["Aurora Cliff tests every keeper.", "Show me your bond!"],
	...
	add_trainer(Vector2i(14, 14), "left", {
		"id": "aurora_cliff_t1", "name": "Mystic Noa", "look": 5,
		"party": [{ "id": "marowl", "level": 46 }, { "id": "torrentag", "level": 47 }, { "id": "snaptide", "level": 48 }],
		"reward": 8,
		"intro": ["Aurora Cliff tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_trainer(Vector2i(6, 17), "up", {
		"id": "aurora_cliff_t2", "name": "Ranger Tess", "look": 8,
		"party": [{ "id": "naiaqua", "level": 47 }, { "id": "riverwyrm", "level": 48 }],
		"reward": 9,
		"intro": ["Aurora Cliff tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_npc(Vector2i(11, 20), "left", Color(1, 1, 1), {
		"type": "npc",
		"lines": [
			"Lights dance where ice meets sky.",
...
func _place_pickups() -> void:
	add_pickup(Vector2i(3, 19), "echo_capsule", 4)
