...
## EMBER FORGE — discoverable themed area.
...
func _build_map() -> void:
	...
	add_warp(Vector2i(9, 23), "desert2", Vector2i(3, 10), "down")
	add_warp(Vector2i(10, 23), "desert2", Vector2i(4, 10), "down")
	...
	add_interact(Vector2i(9, 21), { "type": "sign", "text": "EMBER FORGE - Abandoned smithy still glowing with old heat." })

	add_trainer(Vector2i(5, 10), "right", {
		"id": "ember_forge_t0", "name": "Scholar Otto", "look": 17,
		"party": [{ "id": "geodrake", "level": 17 }, { "id": "ironrust", "level": 18 }],
		"reward": 4,
		"intro": ["Ember Forge tests every keeper.", "Show me your bond!"],
	...
	add_trainer(Vector2i(14, 14), "left", {
		"id": "ember_forge_t1", "name": "Warden Pia", "look": 17,
		"party": [{ "id": "sarcophage", "level": 18 }, { "id": "gravelo", "level": 19 }, { "id": "quarrywyrm", "level": 20 }],
		"reward": 5,
		"intro": ["Ember Forge tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_trainer(Vector2i(6, 17), "up", {
		"id": "ember_forge_t2", "name": "Seeker Cal", "look": 13,
		"party": [{ "id": "colossite", "level": 19 }, { "id": "pebblepup", "level": 20 }],
		"reward": 6,
		"intro": ["Ember Forge tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_npc(Vector2i(11, 20), "left", Color(1, 1, 1), {
		"type": "npc",
		"lines": [
			"Abandoned smithy still glowing with old heat.",
