...
## MUSHROOM GROTTO — discoverable themed area.
...
func _build_map() -> void:
	...
	encounter_table = "mushroom_grotto"
	...
	add_warp(Vector2i(9, 23), "route2", Vector2i(15, 10), "down")
	add_warp(Vector2i(10, 23), "route2", Vector2i(16, 10), "down")
	...
	add_interact(Vector2i(9, 21), { "type": "sign", "text": "MUSHROOM GROTTO - Bioluminescent fungi carpet a damp hollow." })

	add_trainer(Vector2i(5, 10), "right", {
		"id": "mushroom_grotto_t0", "name": "Scholar Otto", "look": 8,
		"party": [{ "id": "petallure", "level": 10 }, { "id": "mycelith", "level": 11 }],
		"reward": 3,
		"intro": ["Mushroom Grotto tests every keeper.", "Show me your bond!"],
	...
	add_trainer(Vector2i(14, 14), "left", {
		"id": "mushroom_grotto_t1", "name": "Warden Pia", "look": 11,
		"party": [{ "id": "thornwhip", "level": 11 }, { "id": "duskling", "level": 12 }, { "id": "gloomkin", "level": 13 }],
		"reward": 4,
		"intro": ["Mushroom Grotto tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_trainer(Vector2i(6, 17), "up", {
		"id": "mushroom_grotto_t2", "name": "Seeker Cal", "look": 16,
		"party": [{ "id": "sporewalk", "level": 12 }, { "id": "wispurr", "level": 13 }],
		"reward": 5,
		"intro": ["Mushroom Grotto tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_npc(Vector2i(11, 20), "left", Color(1, 1, 1), {
		"type": "npc",
		"lines": [
			"Bioluminescent fungi carpet a damp hollow.",
