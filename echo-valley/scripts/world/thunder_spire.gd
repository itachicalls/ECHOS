...
## THUNDER SPIRE — discoverable themed area.
...
func _build_map() -> void:
	...
	add_warp(Vector2i(9, 23), "storm1", Vector2i(16, 10), "down")
	add_warp(Vector2i(10, 23), "storm1", Vector2i(17, 10), "down")
	...
	add_interact(Vector2i(9, 21), { "type": "sign", "text": "THUNDER SPIRE - A lone needle of stone that invites lightning." })

	add_trainer(Vector2i(5, 10), "right", {
		"id": "thunder_spire_t0", "name": "Scout Mira", "look": 10,
		"party": [{ "id": "dynamo", "level": 26 }, { "id": "spaero", "level": 27 }],
		"reward": 5,
		"intro": ["Thunder Spire tests every keeper.", "Show me your bond!"],
	...
	add_trainer(Vector2i(14, 14), "left", {
		"id": "thunder_spire_t1", "name": "Keeper Jon", "look": 0,
		"party": [{ "id": "arcwing", "level": 27 }, { "id": "voltforge", "level": 28 }, { "id": "tempestrix", "level": 29 }],
		"reward": 6,
		"intro": ["Thunder Spire tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_trainer(Vector2i(6, 17), "up", {
		"id": "thunder_spire_t2", "name": "Sage Lira", "look": 5,
		"party": [{ "id": "tempestria", "level": 28 }, { "id": "cyclora", "level": 29 }],
		"reward": 7,
		"intro": ["Thunder Spire tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_legend_encounter(Vector2i(9, 6), "thunderoc", 32,
		"The needle sings. THUNDEROC dives from a black cloud!")

	add_npc(Vector2i(11, 20), "left", Color(1, 1, 1), {
		"type": "npc",
		"lines": [
			"A lone needle of stone that invites lightning.",
