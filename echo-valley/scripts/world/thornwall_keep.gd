...
## THORNWALL KEEP — discoverable themed area.
...
func _build_map() -> void:
	...
	encounter_table = "thornwall_keep"
	...
	add_warp(Vector2i(9, 23), "jungle3", Vector2i(3, 10), "down")
	add_warp(Vector2i(10, 23), "jungle3", Vector2i(4, 10), "down")
	...
	add_interact(Vector2i(9, 21), { "type": "sign", "text": "THORNWALL KEEP - A briar-fort held by stubborn rangers." })

	add_trainer(Vector2i(5, 10), "right", {
		"id": "thornwall_keep_t0", "name": "Seeker Cal", "look": 14,
		"party": [{ "id": "prismshard", "level": 26 }, { "id": "umbrapaw", "level": 27 }],
		"reward": 5,
		"intro": ["Thornwall Keep tests every keeper.", "Show me your bond!"],
	...
	add_trainer(Vector2i(14, 14), "left", {
		"id": "thornwall_keep_t1", "name": "Mystic Noa", "look": 6,
		"party": [{ "id": "nocturn", "level": 27 }, { "id": "duskmaw", "level": 28 }, { "id": "tenebris", "level": 29 }],
		"reward": 6,
		"intro": ["Thornwall Keep tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_trainer(Vector2i(6, 17), "up", {
		"id": "thornwall_keep_t2", "name": "Ranger Tess", "look": 5,
		"party": [{ "id": "shadelet", "level": 28 }, { "id": "wraithorn", "level": 29 }],
		"reward": 7,
		"intro": ["Thornwall Keep tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_npc(Vector2i(11, 20), "left", Color(1, 1, 1), {
		"type": "npc",
		"lines": [
			"A briar-fort held by stubborn rangers.",
