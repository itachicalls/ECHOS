...
## CORAL CATHEDRAL — discoverable themed area.
...
func _build_map() -> void:
	...
	encounter_table = "coral_cathedral"
	...
	add_warp(Vector2i(9, 23), "beach1", Vector2i(3, 10), "down")
	add_warp(Vector2i(10, 23), "beach1", Vector2i(4, 10), "down")
	...
	add_interact(Vector2i(9, 21), { "type": "sign", "text": "CORAL CATHEDRAL - Tide-built spires of living reef." })

	add_trainer(Vector2i(5, 10), "right", {
		"id": "coral_cathedral_t0", "name": "Scholar Otto", "look": 1,
		"party": [{ "id": "cosmindra", "level": 17 }, { "id": "aeonmind", "level": 18 }],
		"reward": 4,
		"intro": ["Coral Cathedral tests every keeper.", "Show me your bond!"],
	...
	add_trainer(Vector2i(14, 14), "left", {
		"id": "coral_cathedral_t1", "name": "Warden Pia", "look": 14,
		"party": [{ "id": "telephase", "level": 18 }, { "id": "siphon", "level": 19 }, { "id": "marowl", "level": 20 }],
		"reward": 5,
		"intro": ["Coral Cathedral tests every keeper.", "Show me your bond!"],
		"win_line": "Well fought. Come talk again — I know a path you might have missed.",
		"after_lines": [
	...
	add_trainer(Vector2i(6, 17), "up", {
		"id": "coral_cathedral_t2", "name": "Seeker Cal", "look": 16,
	...
	add_npc(Vector2i(11, 20), "left", Color(1, 1, 1), {
		"type": "npc",
		"lines": [
			"Tide-built spires of living reef.",
