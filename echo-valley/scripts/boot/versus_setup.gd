...
const RES_FILTER := [-1, EchoTypes.Resonance.FIRE, EchoTypes.Resonance.WATER, EchoTypes.Resonance.GRASS, EchoTypes.Resonance.ROCK, EchoTypes.Resonance.AIR, EchoTypes.Resonance.SHADOW, EchoTypes.Resonance.ELECTRIC, EchoTypes.Resonance.PSYCHIC]
const ECHO_BOX_H := 48
